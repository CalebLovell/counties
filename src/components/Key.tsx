...
export const Key = () => {
	...
	const colors = [color8, color7, color6, color5, color4, color3, color2, color1];

	if (!keyIsVisible) return null;
	return (
		<div className="absolute top-2 right-3 rounded-lg p-3 flex items-center space-x-3 bg-slate-300 bg-opacity-80 backdrop-blur-sm">
