import { ArrowRightCircleIcon, Bars3BottomLeftIcon, CalendarIcon } from "@heroicons/react/24/solid";
			...
			<header className="flex h-12 w-full items-center justify-center bg-gray-50 p-2">
				<div className="flex w-full max-w-3xl items-center justify-between">
					...
					<div className="flex items-center">
						...
						<h1 className="text-center text-base font-bold text-gray-900 sm:text-xl">USA County Map</h1>
					</div>
					<div className="flex">
						<button
