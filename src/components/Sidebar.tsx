...
import { ArrowPathRoundedSquareIcon, KeyIcon, TableCellsIcon, XMarkIcon } from '@heroicons/react/24/solid';
...
export const Sidebar = () => {
	const { sidebarIsOpen, setSidebarIsOpen, keyIsVisible, setKeyIsVisible, panelIsVisible, setPanelIsVisible } = useAppStore();
	...
	return (
		<Transition show={sidebarIsOpen} as={React.Fragment}>
