...
async function main() {
	...
	try {
		...
		// Save to JSON file
		await fs.writeFile("data/output/us_county_election_2024.json", JSON.stringify(electionData, null, 2));
		console.log("✓ Saved to: data/output/us_county_election_2024.json");
		...
		const csvRows = electionData
			...
			.join("\n");
		await fs.writeFile("data/output/us_county_election_2024.csv", csvHeader + csvRows);
		console.log("✓ Saved to: data/output/us_county_election_2024.csv");
